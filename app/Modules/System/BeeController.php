...
class BeeController extends SystemController{
    ...
    public function walletTransactions(Request $request){
        ...
        $data['next_page_url'] = str_replace('http://68.65.123.78','', $data['next_page_url']);
...
//        whereBetween($eloquentData,'payment_transactions.total_amount',$request->total_amount1,$request->total_amount2);
    ...
    public function allNews(){
        $result = News::with('category')
            ...
            ->paginate(10)->withPath('http://68.65.123.78/e-yamamah/public/system/payment-api/allNews')->toArray();
...
//        exit;
       ...
       // $data = Bee::handleResponseData('ServiceList',file_get_contents('http://e-yamamah.com/e-yamamah.xml'));
