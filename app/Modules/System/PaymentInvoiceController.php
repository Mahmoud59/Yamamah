...
class PaymentInvoiceController extends SystemController
{
    ...
    public function index(Request $request){
        if($request->isDataTable){
            ...
            // View Data
            $this->viewData['tableColumns'] = ['#',__('ID'),__('T ID'),__('Service'),__('User'),__('Total'),__('Total Amount'),__('Status'),__('Date'),__('Action'),__('SYSTEM-TOTAL'),__('SYSTEM-TOTAL-AMOUNT')];
            $this->viewData['breadcrumb'][] = [
                'text'=> __('Invoice')
            ];
