	...
	<body>
		...
		<nav class="navbar navbar-default">
		  <div class="container">
		    ...
		    <div class="navbar-header">
		      ...
		      <!-- logo -->
		      <a class="navbar-brand" href="http://e-yamamah.com/"><img src="website/logo.png" style="width: 120px;" /></a>
		    </div>
					...
					<div class="info">
						<div class="col-sm-4">
							<div class="item">
								...
								<h6>Phone</h6>
								<p><a href="tel:+201212181321">+2 01212181321</a></p>
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="item">
								...
								<h6>Mail</h6>
								<p><a href="mailto:info@e-yamamah.com">info@e-yamamah.com</a></p>
							</div>
						</div>
		...
		<footer>
			<div class="main-footer text-center">
				<h4 class="footer-logo"><span>YAMAMAH </span></h4>
			...
			<div class="sub-footer">
				<p>Copy Right &copy; By YAMAMAH 2017 | All Rights Reserved.</p>
			</div>
		</footer>
		<!--====== End Footer ======-->
