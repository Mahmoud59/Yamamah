        ...
        if($request->isDataTable){
            ...
            return Datatables::eloquent($eloquentData)
                ...
                ->addColumn('icon',function($data){
                    if(!$data->icon) return '--';
                    return '<img style="width: 70px;height: 70px;" src="'.asset('storage/public/'.imageResize($data->icon,70,70)).'" />';
                })
        ...
        if($request->isMerchant){
            ...
            return Datatables::eloquent($eloquentData)
                ...
                ->addColumn('logo',function($data){
                    if(!$data->logo) return '--';
                    return '<img style="width:70px;height:70px" src="'.asset('storage/public/'.imageResize($data->logo,70,70)).'" />';
                })
                ->addColumn('name', function($data){
