...
class SubMerchantController extends MerchantController
{
    ...
    public function index(Request $request){
        ...
        if($request->isDataTable){
            ...
            // View Data
            $this->viewData['tableColumns'] = [__('ID'),__('Logo'),__('Name'),__('Wallet'),__('Counter'),__('Action'),__('Status')];
    ...
    public function store(Request $request){
        ...
        $RequestData['staff_email'] = $RequestData['staff_national_id'].'@yamamah.com';
        try {
