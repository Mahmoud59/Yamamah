    ...
    public function index(Request $request){
        ...
        */
        ...
        if($request->isDataTable){
                ...
                ->addColumn('action',function($data){
                    ...
                    return " <div class=\"dropdown\">
                              ...
                              <ul class=\"dropdown-menu\">
                                <li class=\"dropdown-item\"><a href=\"".route('merchant.branches.show',$data->id)."\">".__('View')."</a></li>
                                <li class=\"dropdown-item\"><a href=\"".route('merchant.branches.edit',$data->id)."\">".__('Edit')."</a></li>
                                <li class=\"dropdown-item\"><a onclick=\"deleteRecord('".route('merchant.branches.destroy',$data->id)."')\" href=\"javascript:void(0)\">".__('Delete')."</a></li>
                              </ul>
                            </div>";
                })
            ...
            // View Data
            $this->viewData['tableColumns'] = ['ID','Logo','Name','Address','Map','Action','Status'];
