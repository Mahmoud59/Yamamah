...
Route::get('/rrrr', function () {
    ...
    echo "\n";
    echo public_path('app/public_html/');
});
...
Route::group(['prefix'=>'system'],function(){
    ...
    // Notifications
    Route::get('/nwallet/transactionsotifications/{ID}', 'NotificationController@url')->name('system.notifications.url'); //
...
/*
    ...
    Route::group(['prefix'=>'store'],function(){
        Route::get('/404', 'Store\CardTypeController@error404')->name('system.store.404');
        Route::resource('/card_types','Store\CardTypeController', ['as'=>'system.store']);
        Route::resource('/cards','Store\CardController', ['as'=>'system.store']);
		Route::get('/db',function(){
			...
			Schema::create('cards', function($table)
			{
				...
				$table->integer('sys_id')->unsigned()->nullable();
				$table->integer('operation_provider_id')->unsigned();
				$table->timestamps();
			});*/
		});
    });
