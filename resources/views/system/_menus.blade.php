           ...
           'sub'=>[
               'CardTypes'=> [
                   ...
                   'sub'=>[
                       [
                           'permission'=> [],
                           'url'=> route('system.store.card_types.create'),
                           'text'=> __('Add new card type')
                       ],
                       [
                           'permission'=> [],
                           'url'=> route('system.store.card_types.index'),
                           'text'=> __('View card types')
                       ]
                   ]
               ],
               'Cards'=> [
                   ...
                   'sub'=>[
                       [
                           'permission'=> [],
                           'url'=> route('system.store.cards.create'),
                           'text'=> __('Add new card')
                       ],
                       [
                           'permission'=> [],
                           'url'=> route('system.store.cards.index'),
                           'text'=> __('View cards')
                       ]
                   ]
               ],
