    ...
    <div class="app-content content container-fluid">
        <div class="content-wrapper">
            ...
            <div class="content-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                <div class="card-block card-dashboard">
                                                    ...
                                                    <input name="parent_id_handle" value="<?php echo (!empty($parent_id )?$parent_id:null); ?>" hidden/>
                                                    <div class="form-group col-sm-12{!! formError($errors,'parent_id',true) !!}">
                                                        <div class="controls">
                                                            ...
                                                            @else
                                                                {!! Form::select('parent_id',[__('Select Merchant')],isset($parent_id )?$parent_id:old('parent_id'),['style'=>'width: 100%;','class'=>'select2 form-control']) !!}
                                                            @endif
                                                        </div>
                ...
                {!! Form::select('parent_id',[$result->parent_id => $result->{'name_'.$systemLang}.' #ID: '.$result->parent_id],isset($result->id) ? $result->parent_id:old('parent_id'),['class'=>'select2 form-control']) !!}
                                                    @else
