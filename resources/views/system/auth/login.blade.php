...
<head>
    ...
    <title>YAMAMAH - System Login</title>
                    ...
                    <div class="card border-grey border-lighten-3 m-0">
                        <div class="card-header no-border">
                            <div class="card-title text-xs-center">
                                <div class="p-1"><img style="width: 50%" src="{{asset('assets/logo.png')}}" alt="YAMAMAH"></div>
                            </div>
                            <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login To YAMAMAH</span></h6>
                        </div>
