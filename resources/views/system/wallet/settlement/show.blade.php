                    ...
                    <div class="col-md-12">
                        ...
                        <section class="card">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <div class="table-responsive">
                                        <table id="yamamah-datatable" class="table table-striped table-bordered">
                                            <thead>
                                            <tr>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="card">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <div class="table-responsive">
                                        <table id="yamamah-datatable-WalletTransaction" class="table table-striped table-bordered">
                                            <thead>
                                            <tr>
...
@section('footer')
    <script type="text/javascript">
        ...
        // Wallet Transaction
        $dataTableVarWalletTransaction = $('#yamamah-datatable-WalletTransaction').DataTable({
            "iDisplayLength": 25,
            processing: true,
            serverSide: true,
            "order": [[ 0, "desc" ]],
        ...
        $('#yamamah-datatable-WalletTransaction tbody').on('click', 'td.details-control', function () {
            var tr = $(this).closest('tr');
