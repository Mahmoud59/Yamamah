...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        $dataTableVar = $('#yamamah-datatable').DataTable({
            ...
            columns: [
            { data: 'id', name: 'id' },
            { data: 'payment_sdk_name', name: 'payment_sdk_name' },
            { data: 'name', name: 'name' },
            { data: 'payment_services_name', name: 'payment_services_name' },
            { data: 'payment_service_api_name', name: 'payment_service_api_name' },
