            ...
            @if(request('without_navbar') == 'true')
                ...
                @else
                        ...
                        <div class="navbar-wrapper">
                            <div class="navbar-header">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="nav-item"><a href="{{route('system.dashboard')}}" class="navbar-brand"><h2 class="brand-text">YAMAMAH</h2></a></li>
                    ...
                    <footer class="footer footer-light navbar-border">
                        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; {{date('Y')}} <a href="https://www.e-yamamah.com" target="_blank" class="text-bold-800 grey darken-2">YAMAMAH </a>, All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">Build with <i style="color: red;" class="fa fa-heart text-city"></i> In Egypt</span></p>
                    </footer>
