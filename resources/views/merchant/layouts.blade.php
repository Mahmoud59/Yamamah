...
<head>
    ...
    <meta name="author" content="YAMAMAH">
    <title>{{$pageTitle}}</title>
    
    <link rel="icon" type="image/png" href="{{asset('android-icon-36x36.png')}}">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{route('panel.merchant.home')}}" class="navbar-brand">
                        <img alt="{{__('Yamammah logo')}}" src="{{asset('android-icon-36x36.png')}}" width="36" height="36" class="brand-logo">
                    </a>
                </li>
