...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <meta name="author" content="YAMAMAH Development Team">
    <title>YAMAMAH - Merchant Login</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="{{asset('assets/system/images/logo/stack-logo-dark.png')}}" width="200" height="150" alt="branding logo"></div>
                </div>
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>{{__('Login To YAMAMAH System')}}</span></h6>
            </div>
